...
if os.getenv("USE_POSTGRES", "0").lower() in {"1", "true", "yes", "on"}:
    DATABASES = {
        "default": {
            "ENGINE": "django.db.backends.postgresql",
            "NAME": os.getenv("POSTGRES_DB", "balance"),
            "USER": os.getenv("POSTGRES_USER", "balance"),
            "PASSWORD": os.getenv("POSTGRES_PASSWORD", "balance"),
